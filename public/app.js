...
//   // set the defaut values  sanity checking
...
//   //add query string object to request url if any
//   var requestUrl = path+"?";
//   var queryNumber = 0
...
//       }
//   }
//   let xmlhttpclient = new XMLHttpRequest();
//   xmlhttpclient.open(method, requestUrl, true);
//   xmlhttpclient.setRequestHeader("Content-Type", "application/json");
  
//   //check if the heaxer object has any props
//   for(headerKey in headers){
//       if(headers.hasOwnProperty(headerKey)){
//          xmlhttpclient.setRequestHeader(headerKey, headers[headerKey]);
...
//       xmlhttpclient.setRequestHeader("token", app.config.sessionToken.id)
//   }
//   xmlhttpclient.onreadystatechange = ()=>{
//       if(xmlhttpclient.readyState == XMLHttpRequest.DONE){
//           let statuscode = xmlhttpclient.status;
//           let response = xmlhttpclient.responseText;
//           if(callback){
//             try{
//                 var responseParsed = JSON.parse(response);
//                 callback(statuscode, responseParsed)
//               }catch(e){
//                 callback(statuscode)
//               }
//           }
...
//   xmlhttpclient.send(payloadString);
